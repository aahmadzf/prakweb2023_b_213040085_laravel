...
<div class="row justify-content-center mt-5">
    <div class="col-md-4">
     ...
     <main class="form-signin w-100 m-auto">
        ...
        <form action="/applications/coba-laravel/public/login" method="post">
            @csrf
        ...
        <small class="d-block text-center mt-2">Not registered? <a href="/applications/coba-laravel/public/register">Register Now!</a></small>
     </main>
    </div>
</div>
